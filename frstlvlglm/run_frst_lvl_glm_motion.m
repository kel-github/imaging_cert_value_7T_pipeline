...
% run_spm12.sh /opt/mcr/v97/ batch /home/jovyan/neurodesktop-storage/imaging_cert_value_7T_pipeline/frstlvlglm/run_frst_lvl_glm_motion.m
...
for irun = 1:nrun
    ...
    if phys_exist_check
        ...
        %motion_tmplt = 'sub-%s_ses-02_task-attlearn_run-%d_desc-motion_timeseries.txt';
        fprintf("\n")
        fprintf("[...]motion_timeseries file missing for subject %s, run %d", this_sub, irun)
        fprintf("\n")
